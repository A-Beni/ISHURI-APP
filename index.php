...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="assets/img/apple-icon">
                ...
                <div class="card-body">
                  <form role="form" action='' method="POST">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" id="signup" name="submit">Sign Up</button>
